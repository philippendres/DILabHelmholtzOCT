...
image = cv2.imread('/content/drive/MyDrive/code/segment-anything-main/private_data/dev39/rec0/1593538403.png')
'''height, width = image.shape[:2]
new_width = width // 2
new_height = height // 2
new_image = image[:new_height, :new_width]'''
...
sam_checkpoint = "/content/drive/MyDrive/code/segment-anything-main/sam_vit_h_4b8939.pth"
model_type = "vit_h"
...
show_anns(masks)
plt.axis('off')
plt.savefig('1593538403_masks.png')
